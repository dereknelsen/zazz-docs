...
Popovers and menus render dark-on-light by default (a common design touch) via a container style query (`@container style(--use-inverted-popovers: "true")`). To opt a subtree out, flip the flag:

```html
<div style="--use-inverted-popovers: 'false'">…</div>
```
