...
The defaults compose well. When you retune primitives for a project, check the most-common nesting paths in your UI and verify the inner radius stays _visibly_ smaller than the outer.
...
<Cards>
  ...
  <Card
    ...
    description="Shadows pair with primitive radii to define elevated surfaces."
  />
  <Card
    title="Customization"
    href="/docs/practices/customization"
    description="Retuning the multiplier and primitive radii per project or scoped section."
  />
</Cards>
