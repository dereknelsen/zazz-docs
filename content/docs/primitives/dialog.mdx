...
<Cards>
  <Card title="Card" href="/docs/primitives/card" description="Same `--radius-card` and surface conventions as the dialog modal." />
  <Card title="Button" href="/docs/primitives/button" description="The cancel/submit actions inside `dialog__buttons`." />
  <Card title="Layout / Article" href="/docs/foundations/layout" description="`dialog__modal` often composes with `article` for constrained width." />
</Cards>
