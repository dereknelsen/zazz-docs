...
By default, the page follows the operating system's light/dark setting. Nothing required beyond the [`color-scheme` meta tag](/docs/core-files/head) in your `<head>`, which paints the right canvas, scrollbars, and form controls before your CSS even loads.
