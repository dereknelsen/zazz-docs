...
| Class         | Value                                                       |
| ------------- | ----------------------------------------------------------- |
| `shadow-none` | `box-shadow: none; /* 0 0 0 0 transparent */` |
...
```html
<div class="shadow-md rounded-lg p-md" style="background: var(--card)">An elevated card.</div>
```
...
See [\_variables.css](app/zazz/styles/_variables.css) for `--shadow-sm`, `--shadow-lg`, and `--shadow-xl` in full.
