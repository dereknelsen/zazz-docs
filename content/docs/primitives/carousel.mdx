...
<Cards>
  <Card title="Motion" href="/docs/primitives/motion" description="The other behavior-layer primitive. Scroll-triggered animations via `data-zazz`." />
  <Card title="Card" href="/docs/primitives/card" description="The most common slide content. Drop a `card` inside each `data-embla='slide'`." />
</Cards>
