...
<div class="lightbox grid grid-cols-3 gap-xs grid-flow-row">
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="0">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=300&fit=crop" alt="Mountain landscape" loading="lazy" />
  </button>
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="1">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&h=300&fit=crop" alt="Valley with sunlight" loading="lazy" />
  </button>
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="2">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=400&h=300&fit=crop" alt="Forest path" loading="lazy" />
  </button>
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="3">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=400&h=300&fit=crop" alt="Waterfall in forest" loading="lazy" />
  </button>
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="4">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=400&h=300&fit=crop" alt="Lake at sunset" loading="lazy" />
  </button>
  <button class="lightbox__trigger" type="button" command="show-modal" commandfor="lightbox-1" data-embla-start="5">
    <img width="400" height="300" src="https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=400&h=300&fit=crop" alt="Foggy forest" loading="lazy" />
  </button>
        ...
        <div data-embla="viewport">
          <div data-embla="container">
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=900&fit=crop" alt="Mountain landscape" />
            </div>
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&h=900&fit=crop" alt="Valley with sunlight" />
            </div>
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=1200&h=900&fit=crop" alt="Forest path" />
            </div>
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=1200&h=900&fit=crop" alt="Waterfall in forest" />
            </div>
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=1200&h=900&fit=crop" alt="Lake at sunset" />
            </div>
            <div class="lightbox__slide" data-embla="slide">
              <img width="1200" height="900" src="https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&h=900&fit=crop" alt="Foggy forest" />
            </div>
          </div>
        </div>
