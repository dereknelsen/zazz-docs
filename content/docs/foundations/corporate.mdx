---
title: Corporate
description: Brand color scales for primary, secondary, tertiary, and any palette you add.
---
...
<Cards>
  <Card
    ...
    description="The layer that maps the active mode onto specific corporate steps."
  />
  <Card
    title="Grayscale"
    href="/docs/foundations/grayscale"
    description="The neutral and overlay scales that pair with corporate to build a complete theme."
  />
  <Card
    title="Customization"
    href="/docs/practices/customization"
    description="Replacing default scales, adding new ones, and overriding theme mappings."
  />
</Cards>
