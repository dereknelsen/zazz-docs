...
<Cards>
  <Card
    ...
    description="The `--gap-md` value the container math uses for its side padding."
  />
  <Card
    title="Effects"
    href="/docs/foundations/effects"
    description="Shadows and focus rings that sit on top of layout surfaces."
  />
  <Card
    title="Customization"
    href="/docs/practices/customization"
    description="Retuning containers, adding new widths, and scoped overrides for landing pages or sub-apps."
  />
</Cards>
