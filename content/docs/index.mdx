...
**This is not another component library. It's how you build design systems that survive real projects.**

You know how most UI frameworks work: install a package, import components, hope the defaults look right. The moment a client asks for something custom, you're fighting overrides, wrapping components in wrappers, or bolting on a second system that doesn't match the first.

Zazz takes a different approach. It's a variables-driven design framework built on native web standards. No build step. No framework lock-in. No specificity wars. Just tokens, layers, and modern APIs that work wherever you ship code.

It's built around four commitments:

- **Professionalism:** Works across ever-changing tools and frameworks without breaking.
...
- **Battle-tested:** Every component handles light mode, dark mode, accessibility, and keyboard interaction out of the box.
...
- **Presentable out of the box:** Clean, modern defaults that hold up in client presentations.
