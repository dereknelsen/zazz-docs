...
`reveal.js` ships inside the single [`zazz.js`](/docs/getting-started/head#script-load-order) module; its styles are part of `zazz.css`. If you link files individually, include `_reveal.css`:
