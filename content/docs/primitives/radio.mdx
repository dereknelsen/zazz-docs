...
```html
<label class="w-radio radio-group">
  <input type="radio" name="plan" value="starter" class="w-form-formradioinput w-form-formradioinput--inputType-custom radio w-radio-input" />
  <span class="form-label">Starter</span>
</label>

<label class="w-radio radio-group">
  <input type="radio" name="plan" value="pro" class="w-form-formradioinput w-form-formradioinput--inputType-custom radio w-radio-input" />
...
| Webflow | `radio` class on a custom-styled `w-radio-input`. Group wrapper is `w-radio radio-group`. |
| CSS / Tailwind | The same class after [installing utilities.css](/docs/quickstart/css). |

## Where to next

<Cards>
  <Card title="Checkbox" href="/docs/primitives/checkbox" description="The multi-select sibling. Same wrapper pattern." />
  <Card title="Select" href="/docs/primitives/select" description="Better for longer lists of mutually exclusive options." />
</Cards>
