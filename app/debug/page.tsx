...
/**
 * Dev-only gallery that renders every zazz/components/* demo in its own isolated
...
export default function DebugPage() {
  ...
  return (
    <main style={{ maxWidth: "60rem", margin: "0 auto", padding: "2rem 1.5rem" }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 600, marginBottom: "0.5rem" }}>Zazz examples</h1>
        ...
        {examples.map((src) => {
          ...
          return (
            <section key={src}>
              ...
              <div
                style={{ border: "1px solid #e5e5e5", borderRadius: "0.5rem", overflow: "hidden" }}
              >
                <PreviewFrame
                  html={html}
