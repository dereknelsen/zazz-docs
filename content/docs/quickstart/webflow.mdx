...
<Cards>
  <Card title="Foundations" href="/docs/foundations" description="The token system the Webflow kit implements, one collection per page." />
  <Card title="Figma" href="/docs/quickstart/figma" description="Pair the Webflow kit with the Figma kit for a synchronized design-to-build workflow." />
</Cards>
