...
The `zazz-pass` skill lives in the repository at [`.claude/skills/zazz-pass/`](https://github.com/dereknelsen/zazz-docs/tree/main/.claude/skills/zazz-pass) and contains:
...
2. **`references/tokens.md`** — token names and values it can use directly in generated code
3. **`references/components.md`** — correct markup patterns for every component
...
**[github.com/dereknelsen/zazz-docs](https://github.com/dereknelsen/zazz-docs)**
