...
<Cards>
  <Card title="Theme" href="/docs/foundations/theme" description="Where base and overlay tokens resolve into neutral, shade, or tint." />
  <Card title="Corporate" href="/docs/foundations/corporate" description="The other half of color — brand identity scales that pair with grayscale." />
  <Card title="Effects" href="/docs/foundations/effects" description="Shadows derive from neutral; the relationship is worth knowing." />
</Cards>
