...
- **Nineteen primitives.** Buttons, cards, inputs, dialogs, menus, tabs, a carousel, scroll animations. Atomic, accessible, theme-driven.
...
<Cards>
  <Card
    ...
    description="Why Zazz exists and what it refuses to do."
  />
  <Card
    title="Quickstart"
    href="/docs/quickstart"
    description="Get Zazz into your stack in under five minutes."
  />
  <Card
    title="Foundations"
  ...
  <Card
    ...
    description="The atomic UI elements you compose into product."
  />
</Cards>
