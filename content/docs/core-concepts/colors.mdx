...
Two different fades — don't confuse them:
...
Because everything reads tokens, changing your brand color is a single override — see [Theme variables](/docs/core-concepts/theme-variables) for the three scopes:
