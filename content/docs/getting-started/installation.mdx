...
```bash
npm install -g degit
npx degit dereknelsen/zazz-docs/zazz/styles ./local/templates/custom/zazz/styles
npx degit dereknelsen/zazz-docs/zazz/scripts ./local/templates/custom/zazz/scripts
```
...
```bash
pnpm add -g degit
pnpm dlx degit dereknelsen/zazz-docs/zazz/styles ./local/templates/custom/zazz/styles
pnpm dlx degit dereknelsen/zazz-docs/zazz/scripts ./local/templates/custom/zazz/scripts
```
...
```bash
pnpm dlx degit dereknelsen/zazz-docs/zazz/styles/_dialog.css ./local/templates/custom/zazz/styles/_dialog.css
```
