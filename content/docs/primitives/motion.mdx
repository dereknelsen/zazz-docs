...
<Cards>
  <Card title="Foundations / Effects" href="/docs/foundations/effects" description="Shadows and focus rings — the other side of the visual feedback system." />
  <Card title="Customization" href="/docs/practices/customization" description="Set global motion defaults that match the rest of your design tokens." />
</Cards>
