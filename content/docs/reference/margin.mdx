...
```html
<div class="m-md">
  Margin on all sides — var(--gap-md).
</div>
```
...
```html
<div class="mx-lg my-md">
  Generous horizontal margin, modest vertical.
</div>
```
...
```html
<div class="mx-auto" style="width: var(--container)">
...
<div class="mt-lg mb-sm">
  Lots of room above, a little below.
</div>
```
