...
<dialog id="form-dialog-1" class="dialog" closedby="any" data-size="article">
  ...
  <form id="f-new-project-1" class="dialog__body flex flex-col gap-md" method="dialog">
  ...
  <footer class="dialog__footer">
    ...
    <button class="button" data-variant="primary" type="submit" form="f-new-project-1" value="save">Create project</button>
  </footer>
  <button class="button dialog__close" data-size="icon" data-variant="ghost" type="button" commandfor="form-dialog-1" command="close" aria-label="Close dialog">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
      <rect width="256" height="256" fill="none" />
