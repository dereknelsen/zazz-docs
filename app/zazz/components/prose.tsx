const html = /* html */ `
    ...
    <article class="prose">
        <hgroup>
            ...
            <p class="text-xl text-muted-foreground">The Art of Typography</p>
        </hgroup>
        <p class="text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam lectus. Sed sit amet ipsum mauris. Maecenas congue ligula ac quam viverra nec consectetur ante hendrerit. Donec et mollis dolor.</p>
        ...
        <figure class="gap-xs">
            <img sizes="auto" width="800" height="400" src="https://placehold.co/800x400" alt="Placeholder demonstrating figure and image styling within prose" />
