...
<Cards>
  <Card
    ...
    description="The variable collections the Figma kit ships, with the math behind each."
  />
  <Card
    title="Webflow"
    href="/docs/quickstart/webflow"
    description="Pair the Figma kit with the Webflow kit for a synchronized design-to-build workflow."
  />
</Cards>
