...
In small product teams, Zazz acts as the shared language between the designer and the engineer. The designer touches `--gap-md`; the engineer reads `--gap-md`. There's no token-to-code translation layer, no design tokens JSON to maintain. The CSS variables _are_ the design tokens.
...
<Cards>
  <Card
    ...
    href="/docs/how-to-read-these-docs"
    description="Designer track and code track signposts."
  />
