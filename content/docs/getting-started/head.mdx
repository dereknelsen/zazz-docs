...
<Callout type="warn">
CDN scripts are fine for demos. For production, vendor locally or pin exact versions with [SRI](https://srihash.org/) `integrity` hashes. Update the hashes when you bump versions.
</Callout>
