...
export function Badge() {
  return (
    <div className="flex flex-col gap-sm">
      ...
      <a href="#" className="badge" data-size="icon">
      ...
      <div className="flex items-center gap-sm">
      <a href="#" className="badge" data-variant="primary">
        Badge
      </a>
      <a href="#" className="badge" data-variant="primary" data-size="icon">
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          <rect width="256" height="256" fill="none" />
          <circle cx="128" cy="128" r="12" />
          <circle cx="196" cy="128" r="12" />
      ...
      <div className="flex items-center gap-sm">
      <a href="#" className="badge" data-variant="muted">
        Badge
      </a>
      <a href="#" className="badge" data-variant="muted" data-size="icon">
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          <rect width="256" height="256" fill="none" />
          <circle cx="128" cy="128" r="12" />
          <circle cx="196" cy="128" r="12" />
      ...
      <div className="flex items-center gap-sm">
      <a href="#" className="badge" data-variant="ghost">
        Badge
      </a>
      <a href="#" className="badge" data-variant="ghost" data-size="icon">
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          <rect width="256" height="256" fill="none" />
          <circle cx="128" cy="128" r="12" />
          <circle cx="196" cy="128" r="12" />
      ...
      <div className="flex items-center gap-sm">
      <a href="#" className="badge" data-variant="link">
        Badge
      </a>
      <a href="#" className="badge" data-variant="link" data-size="icon">
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          <rect width="256" height="256" fill="none" />
          <circle cx="128" cy="128" r="12" />
          <circle cx="196" cy="128" r="12" />
