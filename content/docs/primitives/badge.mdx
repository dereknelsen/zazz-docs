...
<a class="badge badge-link" href="/category/posts">Posts</a>
```
...
```html
<span class="badge badge-minimal" aria-label="More actions">
  <span class="badge-icon"><!-- kebab icon --></span>
</span>
```
...
<Cards>
  <Card title="Button" href="/docs/primitives/button" description="Same variants, but for actions." />
  <Card title="Avatar" href="/docs/primitives/avatar" description="Often paired with a badge for status." />
  <Card title="Foundations / Radius" href="/docs/foundations/radius" description="`--radius-badge` controls every badge's shape." />
</Cards>
